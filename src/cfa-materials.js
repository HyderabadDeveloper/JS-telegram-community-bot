// Edit this file to change the CFA material menu and the message shown for each choice.
export const cfaMaterials = {
  level1: {
    label: "Level I",
    providers: {
...
// Edit this section to change the FRM material menu and responses.
export const frmMaterials = {
  level1: {
    label: "Level I",
    providers: {
      schweser: { label: "Schweser", message: "FRM Level I - Schweser material\n\nAdd your Schweser Level I notes, QBank, video, or download links here." },
      institute: { label: "GARP Institute", message: "FRM Level I - GARP Institute material\n\nAdd your GARP curriculum, practice-question, or download links here." },
      everything: { label: "Everything", message: "FRM Level I - all material\n\nAdd all Level I material links here, including Schweser and GARP Institute resources." }
    }
  },
  level2: {
    label: "Level II",
    providers: {
      schweser: { label: "Schweser", message: "FRM Level II - Schweser material\n\nAdd your Schweser Level II notes, QBank, video, or download links here." },
      institute: { label: "GARP Institute", message: "FRM Level II - GARP Institute material\n\nAdd your GARP curriculum, practice-question, or download links here." },
      everything: { label: "Everything", message: "FRM Level II - all material\n\nAdd all Level II material links here, including Schweser and GARP Institute resources." }
    }
  }
};
